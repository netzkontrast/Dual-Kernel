...
description: "Interactive tool for exploring and managing the Kohärenz Protokoll knowledge base. Search entities, browse domains, check conflicts, validate schema, and navigate the project."
risk: safe
source: self
tags: "[kohaerenz, knowledge-graph, exploration, search, entities]"
date_added: "2026-03-27"
triggers: kohaerenz-explorer, search entity, browse domain, knowledge graph, entity lookup, conflicts, validate schema, project stats, glossary term, chapter map
---
